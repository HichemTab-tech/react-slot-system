...
describe('React Slot System - Integration Tests', () => {
  ...
  it('should recreate the demo app functionality', () => {
    ...
    expect(screen.getByText('This is the main card content')).toBeDefined();
  ...
  it('should work with layout pattern like in the README', () => {
    ...
    expect(screen.getByText('Custom Navigation')).toBeDefined();
    expect(screen.getByText('Sidebar content')).toBeDefined();
    expect(screen.getByText('Main page content goes here')).toBeDefined();
    expect(screen.getByText('© 2024 My App')).toBeDefined();
  ...
  it('should handle all exports from the library', () => {
    ...
    expect(screen.getByText('Has template')).toBeDefined();
  ...
  it('should maintain type safety in real usage', () => {
    ...
    const TypedCard = hasSlots(({ title, variant = 'primary', disabled = false }: PropsWithChildren<CardProps>) => (
