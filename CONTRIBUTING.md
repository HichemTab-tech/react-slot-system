# 👥 Contributing to React slot system
...
- Browse [existing issues](https://github.com/HichemTab-tech/react-slot-system/issues) to see if your issue or feature idea has already been raised.
- If your idea or issue hasn't been addressed, feel free to [create a new issue](https://github.com/HichemTab-tech/react-slot-system/issues/new).
...
2. Clone your forked repository:
    ...
    ```sh
    git clone https://github.com/YOUR_GITHUB_USERNAME/react-slot-system
    cd react-slot-system
    ```
